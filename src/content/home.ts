// Home content — client feedback (July 2026): the landing now presents the
// studio (introduction + history) before anything else. The intro paragraphs
// are the client's own copy (grammar-corrected draft; final wording to come —
// he said he would retype it).
